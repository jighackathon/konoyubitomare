...
class ProjectMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_member" do
    assert_difference('ProjectMember.count') do
      post project_members_url, params: { project_member: { project_id: @project_member.project_id, status: @project_member.status, user_id: @project_member.user_id } }
    end
  ...
  test "should update project_member" do
    patch project_member_url(@project_member), params: { project_member: { project_id: @project_member.project_id, status: @project_member.status, user_id: @project_member.user_id } }
